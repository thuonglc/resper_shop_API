...
// models
const Comment = require('./v1/models/comment.model');
...
// router
app.use(require('./v1/routes/cart.router'));
app.use(require('./v1/routes/category.router'));
app.use(require('./v1/routes/cloudinary.router'));
app.use(require('./v1/routes/comment.router'));
app.use(require('./v1/routes/coupon.router'));
app.use(require('./v1/routes/index.router'));
app.use(require('./v1/routes/order.router'));
app.use(require('./v1/routes/product.router'));
app.use(require('./v1/routes/sub.router'));
app.use(require('./v1/routes/user.router'));
